...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3c0bb86e3ef4b1a1fab1355833affad0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Richard Mortier"; "Thomas Gazagnaire"];
          homepage = None;
          synopsis =
            "Environment variables for configuring Mirage unikernels";
          description = None;
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("mirage", None)];
                   ...
                   {
                      lib_modules = ["Mirage_env"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-env";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "®Q%\015Ý½Ø]qÓz\148ïª\027î";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
